<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResponsePaymentCard.aspx.cs" Inherits="TaxPaymentsGEL.Pages.ResponsePaymentCard" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="TransationID" Visible="false" runat="server" Text=""></asp:Label>
           <asp:Label ID="lblmensajeerror" style="display:none"  runat="server" Text=""></asp:Label>
                ...
                <div class="container">
                            ...
                            <div class="card text-center single-pricing-pack">
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled text-sm mb-4 pricing-feature-list">
                                        ...
                                        <li>Estado</li>
                                        <li>
                                            <asp:Label ID="lblEstadoTCJ" runat="server"></asp:Label></li>
                                         <li style="display:none">Estado General:</li>
                                        <li style="display:none">
                                            <asp:Label ID="lblEstadoGeneralTCJ" runat="server"></asp:Label></li>
                                    </ul>
                    ...
                    <div class="mt-5 text-center">
                        <div class="download-btn">
                            ...
                            <asp:Button ID="btnFinalizar" Visible="false" CssClass="btn solid-btn mb-3" OnClick="btnFin_Click1" runat="server" Text="Finalizar" />
                        </div>
